...
>
> 该项目README复合扩展HTML标签较多，自带的网页渲染器对此方面优化不完善，[请返回到该项目主页，查看完善内容](https://github.com/hoochanlon/ihs-simple)；有关项目代码涉及到部分组件的兼容性问题 [点击此处](./d-ipynb/平台兼容问题.ipynb)；自动化信息处理生成的报告报表，可查阅 [d-xlsx](./d-xlsx) 目录了解详情。
